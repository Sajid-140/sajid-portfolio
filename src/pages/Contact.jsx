  ...
  return (
    <section className="contact-section" id="contact">
      ...
      <div className="social-icons">
        <a href="https://www.facebook.com/share/19Nv4VuDkU/" className="fa fa-facebook" target="_blank" rel="noopener noreferrer"></a>
        ...
        <a href="https://www.linkedin.com/in/sajid-ali-a7425b332?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="fa fa-linkedin" target="_blank" rel="noopener noreferrer"></a>
      </div>
